...
public final class ArrayPalette implements Palette {
     ...
     * @param columns     The number of columns to show when determining the layout for this palette.
     * @param names       The names of the colors, or <code>null</code> if the colors don't have names.
     */
     ...
     * @param id             An identifier for this palette.
     * @param paletteName    A string resource id for the palette name.
     * @param colorArray     The integer array resource id for the colors.
     * @param columns        The number of columns to use for the layout.
     * @param colorNameArray A string array resource for the color names.
